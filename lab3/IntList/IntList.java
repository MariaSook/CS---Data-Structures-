...
public class IntList {
    ...
    public static IntList squareListIterative(IntList L) {
        ...
        IntList rest = new IntList(L.first * L.first, null);
        IntList pret = rest;
        L = L.rest;
        while (L != null) {
            pret.rest = new IntList(L.first * L.first, null);
            L = L.rest;
            pret = pret.rest;
        }
        return rest;
     ...
     * Returns a list equal to L with all elements squared. Non-destructive.
     */
    public static IntList squareListRecursive(IntList intlist) {
        if (intlist == null) {
            return null;
        }
        return new IntList(intlist.first * intlist.first, squareListRecursive(intlist.rest));
    }
